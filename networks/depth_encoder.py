...
class LiteMono(nn.Module):
    ...
    Lite-Mono
    """
    def __init__(self, in_chans=3, model='lite-mono-8m',
        ...
        assert model == 'lite-mono-8m', 'Only using lite-mono-8m'
        self.num_ch_enc = np.array([64, 128, 224])
        self.depth = [4, 4, 10]
        self.dims = [64, 128, 224]
        self.dilation = [[1, 2, 3], [1, 2, 3], [1, 2, 3, 1, 2, 3, 2, 4, 6]]
        # https://github.com/noahzn/Lite-Mono/tree/main#kitti
        # https://surfdrive.surf.nl/files/index.php/s/oil2ME6ymoLGDlL
        self.pretrain_link = '1ULWgnlgSaE6UMA8_MBHZMUuGkcBe4C5j'
